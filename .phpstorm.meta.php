...
'telescope','dashboard','invoices.index','invoices.create',
'invoices.store','invoices.show','invoices.edit','invoices.update','invoices.destroy','profile.edit','profile.update','profile.destroy','password.edit',
...
'AWS_URL','VITE_APP_NAME','SCOUT_DRIVER','SCOUT_QUEUE','MEILISEARCH_HOST',
'MEILISEARCH_KEY','MEILISEARCH_NO_ANALYTICS',);
